...
- Update `CONNECTORS.md` and `.mcp.json` with OpenClaw and private admin hooks.

## Success Criteria
- Global rename complete.
- Shadow workflow logic handles Vault RE JSON and Gemini Pro synthesis.
- OpenClaw is established as a core social media connector.
